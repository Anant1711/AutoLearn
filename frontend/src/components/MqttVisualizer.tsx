...
export const MqttVisualizer: React.FC = () => {
    ...
    return (
        <div className="flex flex-col bg-gray-950 min-h-full p-4 gap-4">
            ...
            <div className="bg-[#0d1117] rounded-2xl border border-gray-800 overflow-hidden shadow-2xl">
                ...
                <div className="flex items-center justify-between px-5 py-2.5 border-b border-gray-800 bg-gray-900/60">
                    ...
                    <span className={`px-2.5 py-0.5 rounded text-[10px] font-mono font-bold ${connected ? 'bg-emerald-500/15 text-emerald-400 border border-emerald-500/30' : 'bg-red-500/10 text-red-400 border border-red-500/20'}`}>
            ...
            <div className="grid grid-cols-1 xl:grid-cols-5 gap-4">
                ...
                <div className="xl:col-span-2 flex flex-col gap-4">
                    ...
                    {/* Network + QoS */}
                    <div className="bg-[#0d1117] border border-gray-800 rounded-2xl p-4 flex flex-col gap-3">
                    ...
                    <div className="bg-[#0d1117] border border-gray-800 rounded-2xl p-4 flex flex-col gap-4">
                ...
                {/* Right: Terminal + Inbox */}
                <div className="xl:col-span-3 flex flex-col gap-4">
                    {/* Terminal */}
                    <div className="bg-[#0a0e13] border border-gray-800 rounded-2xl p-4 flex flex-col h-56">
                    ...
                    {/* Message Inbox */}
                    <div className="bg-[#0d1117] border border-gray-800 rounded-2xl p-4 flex flex-col gap-3 flex-1">
