        ...
        <div className="flex flex-col bg-gray-950 min-h-full p-4 gap-4">
                    ...
                    <svg viewBox="0 0 900 295" className="absolute inset-0 w-full h-full" preserveAspectRatio="xMidYMid meet">
                        ...
                        {CLIENTS.map(client => (
                            <line key={client.id}
                                ...
                                strokeOpacity={anyOffered ? (activeClientId === client.id ? 0.65 : 0.22) : 0.3}
            ...
            <div className="grid grid-cols-1 xl:grid-cols-5 gap-4">
                ...
                <div className="xl:col-span-3">
                    <div className="bg-[#0a0e13] border border-gray-800 rounded-2xl p-4 flex flex-col min-h-[440px]">
