            ...
            <div>
                ...
                <div className="flex gap-2 md:gap-4 justify-center">
                    ...
                    <button
                        ...
                        className="select-none touch-manipulation flex flex-col items-center justify-center w-28 h-28 md:w-32 md:h-32 bg-gradient-to-b from-red-600 to-red-800 rounded-lg shadow-lg active:scale-95 active:shadow-inner transition-all duration-150 border-b-4 border-red-900 active:border-b-0 active:translate-y-1"
                    >
